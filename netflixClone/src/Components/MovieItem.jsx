    ...
    <div className='relative w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block rounded-lg overflow-hidden cursor-pointer m-2'>
      <img className='w-full h-40 block object-cover object-top'
       ...
       <div className='absolute top-0 left-0 w-full h-40 bg-black/80 opacity-0 hover:opacity-100'>
            ...
            <p onClick={markFavShow} className='cursor-pointer'>{like?<FaHeart size={20} className='absolute top-2 left-2 text-gray-300'/>:
            <FaRegHeart size={20} className='absolute top-2 left-2 text-gray-300'/>}</p>
       </div>
    </div>
  )
}
